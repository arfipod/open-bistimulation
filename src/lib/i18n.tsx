...
const translations = {
  en: {
    ...
    'landing.tactileText': 'Optional tactile output can use a local Joy-Con bridge on the controller computer.',
    ...
    'tactile.joyConBridge': 'Local Joy-Con bridge',
    'tactile.bridgeOffline': 'Bridge offline',
    'tactile.bridgeConnected': 'Bridge connected',
    ...
    'tactile.stopRumble': 'Stop rumble',
    'tactile.refreshDevices': 'Refresh devices',
    'tactile.localBridgeUrl': 'Local bridge URL',
    'tactile.notDetected': 'Not detected',
    'tactile.invalidBridgeUrl': 'Enter a valid http:// or https:// URL.',
    'tactile.bridgeRequirement': 'Connect both Joy-Cons over Bluetooth, then run npm run joycon:bridge on this computer.',
    'tactile.bridgeNote': 'Joy-Con tactile output will be configured from this browser through the local Joy-Con bridge.',
    ...
    'tactile.lastPulse': 'Last Joy-Con pulse',
    'tactile.noPulseYet': 'None yet',
    'tactile.lastPulseValue': '{side} at {at}',
    'tactile.pulseCount': 'Pulse count',
    'tactile.skippedPulseCount': '{value} skipped',
    'tactile.outputError': 'Tactile error: {error}',
    'tactile.note': 'These settings will drive left/right Joy-Con pulses once the local bridge is connected.',
  ...
  es: {
    ...
    'landing.tactileText': 'La salida táctil opcional puede usar un puente Joy-Con local en el ordenador de control.',
    ...
    'tactile.joyConBridge': 'Puente Joy-Con local',
    'tactile.bridgeOffline': 'Puente desconectado',
    'tactile.bridgeConnected': 'Puente conectado',
    ...
    'tactile.stopRumble': 'Detener rumble',
    'tactile.refreshDevices': 'Actualizar mandos',
    'tactile.localBridgeUrl': 'URL del puente local',
    'tactile.notDetected': 'No detectado',
    'tactile.invalidBridgeUrl': 'Introduce una URL http:// o https:// válida.',
    'tactile.bridgeRequirement': 'Conecta ambos Joy-Con por Bluetooth y ejecuta npm run joycon:bridge en este ordenador.',
    'tactile.bridgeNote': 'La salida táctil Joy-Con se configurará desde este navegador mediante el puente Joy-Con local.',
    ...
    'tactile.lastPulse': 'Último pulso Joy-Con',
    'tactile.noPulseYet': 'Ninguno todavía',
    'tactile.lastPulseValue': '{side} a las {at}',
    'tactile.pulseCount': 'Número de pulsos',
    'tactile.skippedPulseCount': '{value} omitidos',
    'tactile.outputError': 'Error táctil: {error}',
    'tactile.note': 'Estos ajustes controlarán los pulsos Joy-Con izquierdo/derecho cuando el puente local esté conectado.',
