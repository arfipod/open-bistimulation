...
const translations = {
  en: {
    ...
    'landing.tactileText': 'Tactile output is intended to use a local Joy-Con bridge in a later step.',
  ...
  es: {
    ...
    'landing.tactileText': 'La salida táctil está pensada para usar un puente Joy-Con local en un paso posterior.',
