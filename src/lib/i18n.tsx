...
const translations = {
  en: {
    ...
    'tactile.joyConBridge': 'Joy-Con bridge',
    ...
    'tactile.bridgeRequirement': 'Joy-Con output requires the local Joy-Con bridge running on this computer.',
  ...
  es: {
    ...
    'tactile.joyConBridge': 'Puente Joy-Con',
    ...
    'tactile.bridgeRequirement': 'La salida Joy-Con requiere que el puente Joy-Con local esté ejecutándose en este ordenador.',
