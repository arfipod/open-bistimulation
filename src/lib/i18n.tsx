...
const translations = {
  en: {
    ...
    'landing.visualText': 'Color, background, speed, position, and horizontal, vertical, diagonal, and infinity directions.',
  ...
  es: {
    ...
    'landing.visualTitle': 'Visual',
    'landing.visualText': 'Color, fondo, velocidad, posicion y direcciones horizontal, vertical, diagonal e infinito.',
